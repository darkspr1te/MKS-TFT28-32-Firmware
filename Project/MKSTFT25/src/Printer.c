...
/*	memset(gCfgItems.curBedTemp, 0, sizeof(gCfgItems.curBedTemp));
	...
	gCfgItems.language = LANG_ENGLISH;//Ӣ��
...
*/
	...
	gCfgItems.background_color = 0x000000;//��ɫ
	gCfgItems.title_color = 0xFFFFFF;//��ɫ
	gCfgItems.state_background_color = 0x000000;//����ɫ
	gCfgItems.state_text_color = 0xFFFFFF;//��ɫ
	gCfgItems.filename_background_color = 0x000000;//��ɫ
	gCfgItems.filename_color = 0xFFFFFF;//��ɫ
	gCfgItems.printingstate_word_background_color = 0x000000;//��ɫ
	gCfgItems.printingstate_word_color = 0xFFFFFF;//��ɫ
	...
	if(gCfgItems.OVERTURN_180 != 0xee) //����ת
	{
		gCfgItems.OVERTURN_180 = 0;
	}
